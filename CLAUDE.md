...
> This file is read by Claude Code. It mirrors [`AGENTS.md`](AGENTS.md), which
> is read by every other AGENTS.md-aware agent (Codex, Copilot, Cursor, Devin,
> OpenCode, Antigravity). **Keep these two files in sync** — when you change
> rules in one, update the other.
...
- Don't let `docs/ARCHITECTURE.md`, this file, or `AGENTS.md` drift from the
  code.
